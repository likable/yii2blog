...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2020 <a href="https://github.com/likable/yii2blog">Yii2blog, </a>
                        built with <i class="fa fa-heart"></i> by <a href="https://github.com/likable">Likable</a>
                    </div>
                </div>
            </div>
        </div>
